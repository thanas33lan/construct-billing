                         ...
                         <div class="box-body">
                              <div class="row">
                                   <div class="col-md-6">
                                        ...
                                        <label for="clientName" class="col-lg-4 control-label">Client Name <span class="mandatory">*</span></label>
                                             <div class="col-lg-7">
                              ...
                              <div class="row">
                                <div class="col-md-6">
                                   ...
                                   <div class="col-md-6">
                                        <div class="form-group">
                                             <label for="clientEmail" class="col-lg-4 control-label">Client Email </label>
                                             <div class="col-lg-7">
                                   ...
                                   <div class="col-md-6">
                                        <div class="form-group">
                                             <label for="phoneNo" class="col-lg-4 control-label">Address <span class="mandatory">*</span></label>
                                             <div class="col-lg-7">
                              ...
                              <div class="col-md-6">
                                   ...
                                   <div class="col-md-6">
                                        <div class="form-group">
                                             <label for="clientEmail" class="col-lg-4 control-label">GSTIN <span class="mandatory">*</span></label>
                                             <div class="col-lg-7">
