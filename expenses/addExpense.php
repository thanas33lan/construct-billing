                         ...
                         <div class="box-body">
                              ...
                              <div class="row">
                                   <div class="col-md-6">
                                        <div class="form-group">
                                             <div class="col-lg-12">
                                                  <label for="purchasedBy" class="control-label">Purchased By</label>
                                   ...
                                   <div class="col-md-6">
                                        <div class="form-group">
                                             <div class="col-lg-12">
                                                  ...
                                                  <textarea class="form-control" id="remarks" name="remarks" placeholder="Enter the remarks" title="Please enter the remarks"></textarea>
                                             </div>
                                        </div>
                                   </div>
                              </div>
