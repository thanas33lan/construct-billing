...
$rs_field = 'Expense Date,Particulars,Purchased From,Purchased By,Quantity,Price,Amount,Payment Status';
...
if(isset($rs_field) && trim($rs_field)!= ''){
    ...
    $expenseList = $db->rawQuery($_SESSION['expenseListQry']);
      $output = array();
     ...
     $filename = 'Expense-list-' . date('d-M-Y-H-i-s') . '.xlsx';
