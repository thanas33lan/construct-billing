                         ...
                         <div class="box-body">
                              <div class="row">
                                   <div class="col-md-6">
                                        <div class="form-group">
                                             <div class="col-lg-12">
                                                  <label for="particulars" class="control-label">Particulars<span class="mandatory">*</span></label>
                                   ...
                                   <div class="col-md-6">
                                        <div class="form-group">
                                             <div class="col-lg-12">
                                                  <label for="purchasedFrom" class="control-label">Purchased From</label>
                              ...
                              <div class="row">
                                   <div class="col-md-6">
                                        <div class="form-group">
                                             <div class="col-lg-12">
                                                  <label for="purchasedBy" class="control-label">Purchased By<span class="mandatory">*</span></label>
                              ...
                              <div class="row">
                                   <div class="col-md-6">
                                        <div class="form-group">
                                             <div class="col-lg-12">
                                                  <label for="price" class="control-label">Price<span class="mandatory">*</span></label>
                                   ...
                                   <div class="col-md-6">
                                        <div class="form-group">
                                             <div class="col-lg-12">
                                                  <label for="amount" class="control-label">Amount<span class="mandatory">*</span></label>
                              ...
                              <div class="row">
                                   <div class="col-md-6">
                                        <div class="form-group">
                                             <div class="col-lg-12">
                                                  <label for="paymentStatus" class="control-label">Payment Status<span class="mandatory">*</span></label>
