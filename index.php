...
// Total Profit
$profitQuery = "SELECT SUM(`actual_price`) AS actual, SUM(`net_amount`) AS original FROM stock_details AS ed INNER JOIN product_details AS pd ON ed.product_id=pd.product_id INNER JOIN bill_product_details AS bpd ON pd.product_id=bpd.product_name";
	...
	<section class="content">
		...
		<div class="row">
			<div class="box" style="margin-left:10px;display: -webkit-inline-box;">
				<h3 class="box-title" style="margin-left:10px;">Use the datepicker to filter : </h3>
