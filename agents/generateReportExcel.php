...
$rs_field = 'Agent Name,Contact Number,Alternate Contact Number,Email,Agent Status';
...
if(isset($rs_field) && trim($rs_field)!= ''){
    ...
    $expenseList = $db->rawQuery($_SESSION['agentQuery']);
      $output = array();
     ...
     $filename = 'Agent-report-' . date('d-M-Y-H-i-s') . '.xlsx';
